...
public class MessageHandler : MonoBehaviour
{
    ...
    [DllImport("__Internal")]
    private static extern void login(string type, string node_idx, string api_idx);
    [DllImport("__Internal")]
    private static extern void logout();
    [DllImport("__Internal")]
    private static extern void reloadData();
    [DllImport("__Internal")]
    ...
    [DllImport("__Internal")]
    private static extern void minigamestart();
    [DllImport("__Internal")]
    ...
    [DllImport("__Internal")]
    private static extern void asset_blend(string assetid, string memo,string type);
    [DllImport("__Internal")]
    ...
    public delegate void ReloadSync();
    public static ReloadSync OnReloadSync;
    ...
    public static void LoginRequest(string type, string node_idx, string api_idx)
    {
        login(type, node_idx, api_idx);
    }
    ...
    public static void Server_MinigameStart() {
        minigamestart();
    }
    ...
    public void Client_ReloadSyncDdata(string playerdata)
    {
    ...
    public static void Server_BlendProfession(string assetid,string memo,string type)
    {
        asset_blend(assetid, memo,type);
    }
    ...
    public void Client_SetAssetData(string assetdata)
    {
        ...
        userModel.assets = JsonHelper.FromJson<AssetModel>(jsonData);
